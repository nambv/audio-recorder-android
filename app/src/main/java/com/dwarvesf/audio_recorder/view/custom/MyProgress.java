package com.dwarvesf.audio_recorder.view.custom;
...
public class MyProgress extends View {
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        innerBottomTextSize = attributes.getDimension(com.github.lzyzsd.circleprogress.R.styleable.DonutProgress_donut_inner_bottom_text_size, default_inner_bottom_text_size);
        innerBottomTextColor = attributes.getColor(com.github.lzyzsd.circleprogress.R.styleable.DonutProgress_donut_inner_bottom_text_color, default_inner_bottom_text_color);
